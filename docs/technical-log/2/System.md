...
::: tip
不过说到底，其实图形化用户界面，本质也是一个程序，操作系统启动后会自动启动这个进程，所以我们并不能感受到，没有窗口的系统长什么样子。

不过如果你接触过`Liunx服务器`，你就能体会到，其实操作系统的核心还是前面提到的6个模块，用户界面仅仅是为了让我们使用更方便而出现的一个程序。
...
我曾是一名程序研发人员，我的coding能力曾在了解了操作系统之后开始突飞猛进。与我而言，拙劣的文笔无法体现我对操作系统赞赏之情，typing至此，突发奇想，让Qwen为操作系统写了一封信，以显仰慕：
...
通过下图可以简单理解内核部分的结构：TODO + 图片：OP内外
